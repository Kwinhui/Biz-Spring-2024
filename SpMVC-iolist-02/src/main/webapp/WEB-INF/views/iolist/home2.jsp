...
<table class="iolist list">
	...
	<tbody>
		...
		<c:set var="IPRICE" value="${IO.io_input eq '1' ? IO.io_price : 0}" />
		<c:set var="OPRICE" value="${IO.io_input eq '2' ? IO.io_price : 0}" />
		...
		<c:set var="ITOTAL" value="${IO.io_input eq '1' ? IO.io_price * IO.io_quan : 0}" />
		<c:set var="OTOTAL" value="${IO.io_input eq '2' ? IO.io_price * IO.io_quan : 0}" />
