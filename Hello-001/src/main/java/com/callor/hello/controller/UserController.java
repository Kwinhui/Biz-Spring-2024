...
public class UserController {
	...
	public String login() {
		...
		// return null 값이 있으면 자동으로 /user/login.jsp 파일을 찾으려고함
		/*
	...
	public String login(String username, String password, Model model) {
		// 누군가가 username, password 라는 변수에 값을 담을거다
		model.addAttribute("username", username);
		// "username" 이름의 변수를 만들어서 username 에 담겨있는 값을 "username"에 담아라
