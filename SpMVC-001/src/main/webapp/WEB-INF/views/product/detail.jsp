	...
	<main class="w3-container">
		<div class="w3-card-4 w3-dark-gray" >
			...
			<div class="w3-section">
				<input data-pcode = "${PD_LIST.p_code}" type="button" value="수정" class="btn_update w3-button w3-green "/>
				<input data-pcode = "${PD_LIST.p_code}" type="button" value="삭제" class="btn_delete w3-button w3-red " />
